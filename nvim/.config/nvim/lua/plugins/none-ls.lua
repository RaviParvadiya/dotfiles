...
return {
    ...
    config = function()
        local null_ls = require("null-ls")
        null_ls.setup({
            sources = { -- PHP: Linting and formatting
            null_ls.builtins.diagnostics.phpcs.with({
                extra_args = {"--standard=PSR12"}
            }), null_ls.builtins.formatting.phpcbf.with({
                extra_args = {"--standard=PSR12"}
            }), -- JS/TS/HTML/CSS/JSON/SCSS: Prettier
            null_ls.builtins.formatting.prettier, -- Python: Black for formatting, flake8 for linting
            null_ls.builtins.formatting.black, null_ls.builtins.diagnostics.flake8,

            -- Go: gofumpt for formatting, golangci-lint for linting
            null_ls.builtins.formatting.gofumpt, null_ls.builtins.diagnostics.golangci_lint,
